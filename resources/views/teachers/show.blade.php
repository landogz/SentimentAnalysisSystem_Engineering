        ...
        <div class="row">
            <div class="col-md-4">
                <div class="stat-card info">
                    <div class="stat-value">{{ $teacher->total_surveys }}</div>
            ...
            <div class="col-md-4">
                <div class="stat-card success">
                    <div class="stat-value">{{ number_format($teacher->average_rating, 1) }}</div>
            ...
            <div class="col-md-4">
                <div class="stat-card warning">
                    <div class="stat-value">{{ $teacher->subjects_count ?? 0 }}</div>
                ...
                <div class="sentiment-analysis-body">
                    <div class="sentiment-chart-container">
                        <div class="chart-container">
                            <canvas id="teacherSentimentPieChart" style="height: 220px;"></canvas>
                        </div>
                    </div>
