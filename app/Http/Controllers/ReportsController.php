...
class ReportsController extends Controller
{
    ...
    public function export(Request $request)
    {
        ...
        $exportData = [
            'title' => 'PRMSU ENGINEERING Student Feedback Report',
            ...
            'surveys' => $surveys->map(function($survey) {
                return [
                    ...
                    'Program' => $survey->subject->program ?? 'N/A',
    ...
    private function exportCSV($data)
    {
        ...
        $callback = function() use ($data) {
            ...
            // Add report header
            fputcsv($file, ['PRMSU ENGINEERING Student Feedback Report']);
            fputcsv($file, ['Generated: ' . $data['generated_at']]);
            fputcsv($file, []);
            
            // Add filters
            fputcsv($file, ['Filters:']);
            fputcsv($file, ['Program', $data['filters']['program']]);
